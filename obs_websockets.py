...
if __name__ == '__main__':
    ...
    obswebsockets_manager.set_source_visibility("*** Mid Monitor", "/// TTS Characters", True)
    # time.sleep(3)
    ...
    obswebsockets_manager.set_source_visibility("*** Mid Monitor", "/// TTS Characters", False)
